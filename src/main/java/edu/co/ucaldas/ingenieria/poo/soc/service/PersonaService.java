...
import edu.co.ucaldas.ingenieria.poo.soc.dto.Reporte;
import edu.co.ucaldas.ingenieria.poo.soc.dto.Respuesta;
import java.io.*; // entrada y salida de datos (input  and output )
import java.util.ArrayList; // implementacion de interfacces de listas dinamicas
import java.util.List;

public class PersonaService {

    final String NOMBRE_ARCHIVO = "usuarios.bin"; // declaracio constante (nombre del archivo)


    public void crearUsuario(String email, String password){

        Respuesta respuesta = new Respuesta(); //instancia de la clase respuesta
        ...
        boolean existencia = existeBinario(); // verificar el archivo 
        if(existencia){
